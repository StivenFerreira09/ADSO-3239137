-- Crear base de datos
IF DB_ID('bd_proyecto') IS NOT NULL DROP DATABASE bd_proyecto;
GO
...
-- Crear tablas (SQL Server usa IDENTITY en vez de AUTO_INCREMENT)
...
-- SQL Server no tiene MD5 nativo, se usa HASHBYTES con CONVERT
INSERT INTO usuario (username, password, estado, id_persona) VALUES
('carlos.r',    CONVERT(VARCHAR(32), HASHBYTES('MD5','pass1234'), 2), 1, 1),
('luisa.g',     CONVERT(VARCHAR(32), HASHBYTES('MD5','pass1234'), 2), 1, 2),
('andres.t',    CONVERT(VARCHAR(32), HASHBYTES('MD5','pass1234'), 2), 1, 3),
('valentina.h', CONVERT(VARCHAR(32), HASHBYTES('MD5','pass1234'), 2), 1, 4),
('miguel.c',    CONVERT(VARCHAR(32), HASHBYTES('MD5','pass1234'), 2), 0, 5);
...
JOIN ciudad c ON b.id_ciudad = c.id_ciudad WHERE c.nombre LIKE '%Medellín%';
...
-- SQL Server usa CONCAT igual que MySQL
...
-- SQL Server usa YEAR() igual que MySQL
